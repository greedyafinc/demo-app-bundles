...
const LOCALES = {
  en: {
    ...
    _label: 'English',
    _speech: 'en-US',
    // tour.js \u2014 first-run orientation tour
    tour_skip: 'Skip tour',
    tour_back: 'Back',
    tour_next: 'Next',
    tour_done: "You're all set",
    tour_step1_title: 'Welcome to Hermes',
    tour_step1_body: "You're already connected to a live AI agent \u2014 no keys, no setup. Just type below to start.",
    tour_step2_title: 'Ask anything',
    tour_step2_body: 'Type your message here and press Enter. Hermes can read files, run tasks, and remember context.',
    tour_step3_title: 'Choose your model',
    tour_step3_body: 'Pick which AI model answers you \u2014 switch any time, even mid-conversation.',
    tour_step4_title: 'Your workspace',
    tour_step4_body: 'Hermes can browse, read, and edit your project files. Open the workspace panel here anytime.',
    tour_step5_title: 'Work that runs itself',
    tour_step5_body: 'Hermes can run jobs in the background and on a schedule \u2014 explore these under Tasks.',
    tour_step6_title: 'Make it yours',
    tour_step6_body: 'Themes, models, and more live in Settings.',
    tour_sc_title: 'What you can do',
    tour_sc_tagline: 'A persistent agent that works in your files, learns reusable skills, and runs on a schedule.',
    tour_sc1_label: 'Build real files',
    tour_sc1_ex: '"Draft a project plan as a Markdown file in my workspace."',
    tour_sc2_label: 'Learn reusable skills',
    tour_sc2_ex: '"Convert these CSVs to clean JSON \u2014 then save it as a skill."',
    tour_sc3_label: 'Run on a schedule',
    tour_sc3_ex: '"Each morning, write a standup note from my git log."',
    tour_sc4_label: 'Any model, one chat',
    tour_sc4_ex: '"/model to switch, then summarize this thread in 3 bullets."',
    tour_sc_try: 'Try an example \u2192',
    tour_sc_done: 'Maybe later',
    tour_sc_try_prompt: 'Create a Markdown file in my workspace called ideas.md with 5 weekend project ideas, then read it back to me.',
    cmd_tour: 'Replay the welcome tour',
    tour_unavailable: 'The welcome tour is unavailable right now.',
    // boot.js
