export interface AgentModelOption {
  ...
  label: string;
  /**
   * Provider / model-author name (e.g. "Anthropic", "OpenAI"), used to resolve
   * the model's brand logo in the web picker. Optional and only populated for
   * the platform-native 'unified' agent, whose catalog comes from the
   * UnifiedAI gateway; local-CLI adapters leave it undefined.
   */
  author?: string;
}
