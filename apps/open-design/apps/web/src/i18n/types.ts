...
export interface Dict {
  ...
  'inlineSwitcher.modelSearch': string;
  'inlineSwitcher.noModels': string;

  // Account-usage chip (UnifiedAI gateway)
  'usage.chipAria': string;
  'usage.title': string;
  'usage.today': string;
  'usage.period': string;
  'usage.input': string;
  ...
  'usage.cost': string;
  'usage.credits': string;
  'usage.unlimited': string;
  'usage.resetsIn': string;
