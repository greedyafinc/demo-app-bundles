...
export const fa: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'جستجوی مدل‌ها',
  'inlineSwitcher.noModels': 'مدلی مطابقت ندارد',
  'usage.chipAria': 'مصرف حساب',
  'usage.title': 'مصرف',
  'usage.today': 'امروز',
  'usage.period': 'این دوره',
  'usage.input': 'ورودی',
  'usage.output': 'خروجی',
  'usage.requests': 'درخواست‌ها',
  'usage.cost': 'هزینه',
  'usage.credits': 'اعتبار',
  'usage.unlimited': 'نامحدود',
  'usage.resetsIn': 'بازنشانی در {when}',
