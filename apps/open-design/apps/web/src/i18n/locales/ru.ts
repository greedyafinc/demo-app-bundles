...
export const ru: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Поиск моделей',
  'inlineSwitcher.noModels': 'Нет подходящих моделей',
  'usage.chipAria': 'Использование аккаунта',
  ...
  'usage.credits': 'Кредиты',
  'usage.unlimited': 'Без ограничений',
  'usage.resetsIn': 'Сброс через {when}',
