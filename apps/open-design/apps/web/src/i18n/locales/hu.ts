...
export const hu: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Modellek keresése',
  'inlineSwitcher.noModels': 'Nincs találat',
  'usage.chipAria': 'Fiókhasználat',
  'usage.title': 'Használat',
  'usage.today': 'Ma',
  'usage.period': 'Ebben az időszakban',
  'usage.input': 'Bemenet',
  'usage.output': 'Kimenet',
  'usage.requests': 'Kérések',
  'usage.cost': 'Költség',
  'usage.credits': 'Kreditek',
  'usage.unlimited': 'Korlátlan',
  'usage.resetsIn': 'Visszaállítás {when} múlva',
