...
export const fr: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Rechercher des modèles',
  'inlineSwitcher.noModels': 'Aucun modèle correspondant',
  'usage.chipAria': 'Utilisation du compte',
  'usage.title': 'Utilisation',
  'usage.today': 'Aujourd\'hui',
  'usage.period': 'Cette période',
  'usage.input': 'Entrée',
  'usage.output': 'Sortie',
  ...
  'usage.resetsIn': 'Réinitialisation dans {when}',
