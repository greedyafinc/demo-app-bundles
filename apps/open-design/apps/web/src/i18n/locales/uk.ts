...
export const uk: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Пошук моделей',
  'inlineSwitcher.noModels': 'Немає відповідних моделей',
  'usage.chipAria': 'Використання акаунта',
  'usage.title': 'Використання',
  'usage.today': 'Сьогодні',
  'usage.period': 'Цей період',
  'usage.input': 'Вхід',
  'usage.output': 'Вихід',
  'usage.requests': 'Запити',
  'usage.cost': 'Вартість',
  'usage.credits': 'Кредити',
  'usage.unlimited': 'Без обмежень',
  'usage.resetsIn': 'Скидання через {when}',
