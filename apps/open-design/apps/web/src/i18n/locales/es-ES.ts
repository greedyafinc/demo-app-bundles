...
export const esES: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Buscar modelos',
  'inlineSwitcher.noModels': 'Sin coincidencias',
  'usage.chipAria': 'Uso de la cuenta',
  'usage.title': 'Uso',
  'usage.today': 'Hoy',
  'usage.period': 'Este periodo',
  'usage.input': 'Entrada',
  'usage.output': 'Salida',
  ...
  'usage.resetsIn': 'Se restablece en {when}',
