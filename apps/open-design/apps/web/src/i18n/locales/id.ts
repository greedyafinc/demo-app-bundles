...
export const id: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Cari model',
  'inlineSwitcher.noModels': 'Tidak ada model yang cocok',
  'usage.chipAria': 'Penggunaan akun',
  'usage.title': 'Penggunaan',
  'usage.today': 'Hari ini',
  'usage.period': 'Periode ini',
  'usage.input': 'Masukan',
  'usage.output': 'Keluaran',
  'usage.requests': 'Permintaan',
  'usage.cost': 'Biaya',
  'usage.credits': 'Kredit',
  'usage.unlimited': 'Tak terbatas',
  'usage.resetsIn': 'Atur ulang dalam {when}',
