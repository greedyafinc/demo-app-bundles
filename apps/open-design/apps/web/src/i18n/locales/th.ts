...
export const th: Dict = {
  ...en,
  'inlineSwitcher.modelSearch': 'ค้นหาโมเดล',
  'inlineSwitcher.noModels': 'ไม่พบโมเดลที่ตรงกัน',
  'usage.chipAria': 'การใช้งานบัญชี',
  ...
  'usage.credits': 'เครดิต',
  'usage.unlimited': 'ไม่จำกัด',
  'usage.resetsIn': 'รีเซ็ตใน {when}',
