...
export const de: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Modelle suchen',
  'inlineSwitcher.noModels': 'Keine passenden Modelle',
  'usage.chipAria': 'Kontonutzung',
  'usage.title': 'Nutzung',
  'usage.today': 'Heute',
  'usage.period': 'Dieser Zeitraum',
  'usage.input': 'Eingabe',
  'usage.output': 'Ausgabe',
  'usage.requests': 'Anfragen',
  'usage.cost': 'Kosten',
  'usage.credits': 'Guthaben',
  'usage.unlimited': 'Unbegrenzt',
  'usage.resetsIn': 'Zurücksetzung in {when}',
