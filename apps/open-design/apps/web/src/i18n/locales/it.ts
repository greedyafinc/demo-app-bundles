...
export const it: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Cerca modelli',
  'inlineSwitcher.noModels': 'Nessun modello corrispondente',
  'usage.chipAria': 'Utilizzo dell\'account',
  'usage.title': 'Utilizzo',
  'usage.today': 'Oggi',
  'usage.period': 'Questo periodo',
  'usage.input': 'Input',
  'usage.output': 'Output',
  'usage.requests': 'Richieste',
  'usage.cost': 'Costo',
  'usage.credits': 'Crediti',
  'usage.unlimited': 'Illimitato',
  'usage.resetsIn': 'Si reimposta tra {when}',
