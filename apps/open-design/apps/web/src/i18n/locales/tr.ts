...
export const tr: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Model ara',
  'inlineSwitcher.noModels': 'Eşleşen model yok',
  'usage.chipAria': 'Hesap kullanımı',
  'usage.title': 'Kullanım',
  'usage.today': 'Bugün',
  'usage.period': 'Bu dönem',
  'usage.input': 'Giriş',
  'usage.output': 'Çıkış',
  'usage.requests': 'İstekler',
  'usage.cost': 'Maliyet',
  'usage.credits': 'Krediler',
  'usage.unlimited': 'Sınırsız',
  'usage.resetsIn': '{when} içinde sıfırlanır',
