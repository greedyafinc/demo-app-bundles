...
export const pl: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Szukaj modeli',
  'inlineSwitcher.noModels': 'Brak pasujących modeli',
  'usage.chipAria': 'Zużycie konta',
  'usage.title': 'Zużycie',
  'usage.today': 'Dziś',
  'usage.period': 'Bieżący okres',
  'usage.input': 'Wejście',
  'usage.output': 'Wyjście',
  'usage.requests': 'Żądania',
  'usage.cost': 'Koszt',
  'usage.credits': 'Środki',
  'usage.unlimited': 'Bez limitu',
  'usage.resetsIn': 'Reset za {when}',
