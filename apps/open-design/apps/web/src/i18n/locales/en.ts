...
export const en: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'Search models',
  'inlineSwitcher.noModels': 'No models match',
  'usage.chipAria': 'Account usage',
  'usage.title': 'Usage',
  'usage.today': 'Today',
  'usage.period': 'This period',
  'usage.input': 'Input',
  'usage.output': 'Output',
