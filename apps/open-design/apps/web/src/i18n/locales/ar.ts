...
export const ar: Dict = {
  ...
  'inlineSwitcher.modelSearch': 'البحث عن النماذج',
  'inlineSwitcher.noModels': 'لا توجد نماذج مطابقة',
  'usage.chipAria': 'استخدام الحساب',
  'usage.title': 'الاستخدام',
  'usage.today': 'اليوم',
  'usage.period': 'هذه الفترة',
  'usage.input': 'المدخلات',
  'usage.output': 'المخرجات',
  'usage.requests': 'الطلبات',
  'usage.cost': 'التكلفة',
  'usage.credits': 'الأرصدة',
  'usage.unlimited': 'غير محدود',
  'usage.resetsIn': 'تتم إعادة التعيين خلال {when}',
