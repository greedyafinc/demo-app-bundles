...
module.exports = {
    packagerConfig: {
        ...
        // Sign + notarize only when Apple credentials are provided; without
        // them (the UnifiedApp marketplace/sideload channel) produce an
        // ad-hoc build — running notarize against an ad-hoc signature fails.
